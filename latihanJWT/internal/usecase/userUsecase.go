...
func (uc UserUsecase) RegisterUser(User domain.User) (*domain.User, error) {
...
func (uc UserUsecase) CheckVerifiedAcc(username string) (bool, error) {
	return uc.UserRepo.CheckVerifiedAcc(username)
}
